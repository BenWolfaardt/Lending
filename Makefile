...
build-darwin: go.sum
	env GOOS=darwin GOARCH=amd64 go build -mod=readonly -o ./build/Darwin-AMD64/lendingCLI
$(BUILD_FLAGS) ./cmd/lendingCLI
	env GOOS=darwin GOARCH=amd64 go build -mod=readonly -o ./build/Darwin-AMD64/lendingD
$(BUILD_FLAGS) ./cmd/lendingD

build-linux: go.sum
	env GOOS=linux GOARCH=amd64 go build -mod=readonly -o ./build/Linux-AMD64/lendingCLI
$(BUILD_FLAGS) ./cmd/lendingCLI
	env GOOS=linux GOARCH=amd64 go build -mod=readonly -o ./build/Linux-AMD64/lendingD
$(BUILD_FLAGS) ./cmd/lendingD

build-windows: go.sum
	env GOOS=windows GOARCH=amd64 go build -mod=readonly -o ./build/Windows-AMD64/lendingCLI.
exe $(BUILD_FLAGS) ./cmd/lendingCLI
	env GOOS=windows GOARCH=amd64 go build -mod=readonly -o ./build/Windows-AMD64/lendingD.
exe $(BUILD_FLAGS) ./cmd/lendingD
