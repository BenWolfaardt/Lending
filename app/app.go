...
type NewApp struct {
	*bam.BaseApp
	...
	crisisKeeper   crisis.Keeper // added
...
func NewInitApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	app.subspaces[crisis.ModuleName] = app.paramsKeeper.Subspace(crisis.DefaultParamspace) // added
	...
	app.crisisKeeper = crisis.NewKeeper( // added
		app.subspaces[crisis.ModuleName],
		invCheckPeriod, app.supplyKeeper,
		auth.FeeCollectorName,
	)
	...
	app.mm = module.NewManager(
		...
		crisis.NewAppModule(&app.crisisKeeper), // added
	)

	app.mm.SetOrderBeginBlockers(distr.ModuleName, slashing.ModuleName)
	app.mm.SetOrderEndBlockers(crisis.ModuleName, staking.ModuleName) // modified
	...
	app.mm.SetOrderInitGenesis(
		...
		lending.ModuleName,
		supply.ModuleName,
		crisis.ModuleName, // added
		genutil.ModuleName,
	)

	// register all module routes and module queriers
	app.mm.RegisterInvariants(&app.crisisKeeper) // added
